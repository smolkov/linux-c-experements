...
static void sigdelete(int signum) { exit(EXIT_FAILURE); }
...
static void server(void) {
  ...
  if (shmdata == (void *)-1) printf("Fehler bei shmat(): shmid %d\n", shmid);
